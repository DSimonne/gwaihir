...
def Plotting(scan_dir, datapath, PlottedValue, PlottedAxes, PlottedDimensions, PlottedIndex):
    ...
    if PlottedDimensions == "2D":
        ...
        if PlottedAxes == "xy":
            plt.savefig(
                f"{scan_dir}slices/xy/{run}_{PlottedAxes}_{PlottedValue}_{i}_2D.png")
            print(
                f"Saved as {scan_dir}slices/xy/{run}_{PlottedAxes}_{PlottedValue}_{i}_2D.png")
        elif PlottedAxes == "yz":
            plt.savefig(
                f"{scan_dir}slices/yz/{run}_{PlottedAxes}_{PlottedValue}_{i}_2D.png")
            print(
                f"Saved as {scan_dir}slices/yz/{run}_{PlottedAxes}_{PlottedValue}_{i}_2D.png")
        elif PlottedAxes == "zx":
            plt.savefig(
                f"{scan_dir}slices/zx/{run}_{PlottedAxes}_{PlottedValue}_{i}_2D.png")
            print(
                f"Saved as {scan_dir}slices/zx/{run}_{PlottedAxes}_{PlottedValue}_{i}_2D.png")
        plt.tight_layout()
        ...
        try:
            ...
            if PlottedAxes == "xy":
                plt.savefig(
                    f"{scan_dir}slices/xy/{run}_{PlottedAxes}_{PlottedValue}_{i}_2DC.png")
                print(
                    f"Saved as {scan_dir}slices/xy/{run}_{PlottedAxes}_{PlottedValue}_{i}_2DC.png")
            elif PlottedAxes == "yz":
                plt.savefig(
                    f"{scan_dir}slices/yz/{run}_{PlottedAxes}_{PlottedValue}_{i}_2DC.png")
                print(
                    f"Saved as {scan_dir}slices/yz/{run}_{PlottedAxes}_{PlottedValue}_{i}_2DC.png")
            elif PlottedAxes == "zx":
                plt.savefig(
                    f"{scan_dir}slices/zx/{run}_{PlottedAxes}_{PlottedValue}_{i}_2DC.png")
                print(
                    f"Saved as {scan_dir}slices/zx/{run}_{PlottedAxes}_{PlottedValue}_{i}_2DC.png")
                # plt.show()
            plt.tight_layout()
